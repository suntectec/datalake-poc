...
public class FlinkCDCTableAPIAndSQL {
    public static void main(String[] args) throws Exception {
        ...
        // tableEnv.createTable("SourceTable", TableDescriptor.forConnector("sqlserver-cdc")
        //         .schema(schema)
        //         .option("hostname", "dev-ds-trm01.tailb6e5ab.ts.net")
        //         .option("port", ""));
